...
namespace DigitalRubyShared
{
    ...
    public struct GestureTouch : IDisposable, IComparable<GestureTouch>
    {
        ...
        /// Constructor
        /// </summary>
        public GestureTouch(int platformSpecificId, float x, float y, float previousX, float previousY, float pressure, float screenX = float.NaN, float screenY = float.NaN, object platformSpecificTouch = null, TouchPhase touchPhase = TouchPhase.Unknown)
        {
